...
return [
    ...
    */
    'features' => [
        'analytics' => true,
        // Dinonaktifkan: paket menulis & menyajikan file via disk filesystem DEFAULT
        // (aplikasi ini = s3), lalu men-download lewat path lokal — tidak kompatibel
        // dengan s3 sehingga memicu FileNotFoundException. Mengubah default disk akan
        // merusak fitur Knowledge (upload ke s3), jadi ekspor dimatikan.
        'exports' => false,
        'saved_views' => true,
    ],
